...
CONDICIONES_BIDAFARMA = {
    ...
    "NN": {
        ...
        "familia": "DIANE",
        "albaranes": {
            "especialidad_iva4_sin_descuento_en_linea": True,
            "neto_cuadra_con_total_compras_factura": True,
            "parafarmacia_puede_llevar_descuento_en_linea": True,
            "excluir_bitransfer_avantia_plataformas_del_ajuste": True,
        },
        "ajuste_comercial": {
            "naturaleza": "descuento",
            "origen": "factura",
            "aplica_sobre": "base_iva4_sujeta",
            "base": "bruto_iva4_goteo_especialidad",
            "excluir": [
                "clubes",
                "especialidad_cara",
                "bitransfer",
            ...
            "calculo": "ajuste_factura_dividido_entre_base_iva4_sujeta",
        },
        "liquidaciones": {
            "en_albaranes_independientes": True,
            "tipos_albaran": ["TX", "TT"],
        ...
        "servicios": {
            ...
            "cargo_parafarmacia_variable": True,
            "cargo_parafarmacia_sobre": "bruto",
            "base_parafarmacia_variable": "parafarmacia_no_financiada_y_panales",
            "patrones_panales": ["pañal", "panal", "pant", "noche", "inco"],
        },
    },
    "NB": {
        "nombre": "Diane Cecofar PVL",
        "alias": ["DIANE CECOFAR PVL", "DIANE CECOFAR PWL"],
        "albaran_74": "solo_liquidaciones",
        "tipo_albaran_74": None,
        "ajuste_comercial_factura": True,
        "cargo_adicional_gestion": False,
        ...
        "ajuste_comercial": {
            ...
            "origen": "factura",
            "aplica_sobre": "base_iva4_sujeta",
            "base": "bruto_iva4_goteo_especialidad_pvl",
            "excluir": [
                "clubes",
                "especialidad_cara",
                "bitransfer",
            ...
            "calculo": "cargo_factura_dividido_entre_base_iva4_sujeta",
        },
        "liquidaciones": {
            "en_albaranes_independientes": True,
            "tipos_albaran": ["TX", "TT"],
    ...
    "XR": {
        "nombre": "Bidalina",
        "alias": ["VIDA LINEA", "VIDA LÍNEA", "BIDALINA"],
        "albaran_74": "solo_bruto",
        "tipo_albaran_74": 1,
        "ajuste_comercial_factura": False,
        "cargo_adicional_gestion": True,
        "familia": "BIDALINA",
        "modelo_condicion": "descuento_cargo_por_linea_y_unidades",
        "albaranes": {
            "pueden_ser_brutos": True,
            "pueden_ser_netos": True,
            "netos_con_descuentos_y_cargos_en_linea": True,
            "brutos_requieren_albaran_74_desglose": True,
        },
        "escalados_linea": {
            "pendiente_definir_tramos": True,
            "criterio": "unidades_por_linea",
            "especialidad": {
                "tipo": "descuento",
                "tramos": [],
            },
            ...
            "analisis": [
                "descuento_medio_por_categoria",
                "descuento_medio_por_cn",
                "descuento_medio_por_rango_unidades",
            ],
        },
        "faceta": {
            "tipo": "desglose",
            "solo_si_albaranes_brutos": True,
            "validar_bases": True,
            "especialidad_normal_puede_tener_descuento": True,
            "especialidad_cara_descuento_en_euros": True,
            "parafarmacia_financiada_separada": True,
            "parafarmacia_no_financiada_puede_tener_cargo": True,
            "imputacion_desglose": "proporcional_por_grupo",
        },
        "gestion": {
            "penalizacion_bajo_consumo": True,
            "importe_penalizacion_bajo_consumo": 50.0,
